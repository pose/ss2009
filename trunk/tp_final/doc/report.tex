...
Además, se utilizó el test de $\chi^2$ para verificar la distribución normal de los tiempos de servicio de ER. La tabla correspondientes al test realizado para verificar la distribución normal de los tiempos de servicios de ER, se ven en la Tabla \ref{tab:chi_table_norm}. %El test $\chi^2$ arrojó un valor de $1.56995$ que implica un nivel de significación de $5\%$. 
