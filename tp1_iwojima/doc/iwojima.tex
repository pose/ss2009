...
\section{Poder K}
\label{sec:kirchner}
El primer resultado obtenido, es analítico y lo presentamos en esta sección. A partir de un modelo sin refuerzos, demostracmos matemáticament
...
Volviendo al caso $K \ne 0$, cuanto m\'as cerca est\'en de la as\'intota las hip\'erbolas son m\'as desgastantes para el ej\'ercito. Esto es decir que aunque sea claramente
...
graficada.\\
Dado un sistema sin funciones de refuerzo, al incorporarse alguna podemos:
\begin{enumerate}
...
como la efectividad de las tropas de una fuerza con respecto a las contrarias.\\
